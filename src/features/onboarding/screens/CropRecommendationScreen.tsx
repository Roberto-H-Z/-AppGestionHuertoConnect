...
const styles = StyleSheet.create({
    ...
    tag: { flexDirection: 'row', alignItems: 'center', backgroundColor: '#F3F4F6', paddingHorizontal: 8, paddingVertical: 4, borderRadius: 6, gap: 4, flexShrink: 1 },
    tagText: { fontSize: 11, fontWeight: '600', color: '#4B5563', flexShrink: 1, flexWrap: 'wrap' },
