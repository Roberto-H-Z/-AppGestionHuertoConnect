...
const styles = StyleSheet.create({
    ...
    mainCard: { backgroundColor: '#fff', borderRadius: 20, padding: 24, shadowColor: '#000', shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.1, shadowRadius: 12, elevation: 5, marginBottom: 24 },
    inputsRow: { flexDirection: 'row', gap: 16, marginBottom: 24 },
    inputGroup: { flex: 1 },
    ...
    dimensionInput: { paddingHorizontal: 16, paddingVertical: 12, fontSize: 18, fontWeight: '600', color: '#059669' },
    previewLabel: { fontSize: 14, color: '#6B7280', marginBottom: 16 },
    previewContainer: { alignItems: 'center', justifyContent: 'center', minHeight: PREVIEW_MAX_SIZE + 20, marginBottom: 8 },
