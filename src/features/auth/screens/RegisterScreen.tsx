    ...
    const handleRegister = async () => {
        ...
        try {
            ...
            if (authError) {
                ...
                } else if (authError.message?.includes('at least 6')) {
                ...
                Alert.alert(
                    '¡Cuenta creada! 🌱',
                    'Tu cuenta ha sido creada exitosamente. Revisa tu correo electrónico para confirmar tu cuenta antes de iniciar sesión.',
                    [
                        {
